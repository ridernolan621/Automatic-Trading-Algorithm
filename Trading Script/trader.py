...
class Strategy:
    ...
    def order(self):
        price = self._make_request(endpoint=pricing.endpoint, params=pricing.params)

        if 'prices' in price and len(price['prices']) > 0:
...
if __name__ == "__main__":
    ...
    oanda.get_signal(oanda.get_candles_data_15, oanda.get_candles_data_H4, oanda.order)